...
<!DOCTYPE html>
<head>
<title>Trang quản lí Admin Website</title>
...
<div class="w3layouts-main">
	...
	<?php
	 ...
	 ?>
		<form action="{{URL::to('/admin-dashborad')}}" method="post">
			{{(csrf_field())}}
			...
			@endforeach
			<input type="email" class="ggg" name="admin_email" placeholder="Điền Email" >

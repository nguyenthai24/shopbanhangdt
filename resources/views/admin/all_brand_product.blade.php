       ...
       ?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-brand-product/'.$brand_pro->brand_id)}}" class="active edit-styling" ui-toggle-class="">
                <i class="fa fa-pencil-square-o text-success text-active"></i>
              </a>
              <a onclick="return confirm('Are you sure delete ?')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active edit-styling" ui-toggle-class="">
